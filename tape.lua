...
return {
    ...
    effects = { -- not yet implemented
        {
            ...
            gain = 0.5,
            edge = 0.25
        }, { name = "standard_reverb", type = 'reverb' }
        -- EFFECTS--------------------------------------------------------------------------------------------------
        --[[
    ...
    sounds = {
        -- the sounds table in an array of tables, every subtable contains info for a specific sound
        {
            ...
            playback = { 8, 16 }, -- random playback between 8 and 16 seconds   -- not yet implemented
            playback = 5, -- playback every 5 seconds -- not yet implemented
